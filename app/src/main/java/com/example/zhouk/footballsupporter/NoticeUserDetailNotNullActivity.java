...
public class NoticeUserDetailNotNullActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.notice_user_detail_not_null);
    ...
    protected void toNoticeList() {
        Button button = (Button) findViewById(R.id.nudnn_confirm);
